---
title: LFE DSL
description: The compile-only Lisp-flavored layer above the Soma runtime — how soma_lfe:compile/2 turns Lisp source into validated step-list maps, the run and arg forms, edge forms, and diagnostics.
---
