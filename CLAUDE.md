...
The **v0.1–v0.6 layers plus the first v0.7.1 persistent-resume slice are built and merged** — all green on `main` (EUnit 227, CT 313), Erlang/OTP 29 + rebar3 3.27. `README.md` remains the authoritative spec — read it before extending anything; the sections below summarize what shapes day-to-day work.
