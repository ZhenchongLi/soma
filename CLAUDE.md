...
The **v0.1–v0.5 layers are built and merged** — all green on `main` (EUnit 135, CT 192), Erlang/OTP 29 + rebar3 3.27. `README.md` remains the authoritative spec — read it before extending anything; the sections below summarize what shapes day-to-day work.
